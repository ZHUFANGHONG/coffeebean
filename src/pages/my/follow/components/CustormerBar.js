...
class Index extends Component{
  render(){
    ...
    return(
      <ImageBackground
      style={{height:pxToDp(60),flexDirection:"row",paddingLeft:pxToDp(20),
      paddingRight:pxToDp(20),justifyContent:"space-evenly",position:"relative"}}
      source={require("../../../../res/rectanglecopy.png")}
      >
        <IconFont name="iconfanhui" style={{color:"#fff",fontSize:pxToDp(20),
