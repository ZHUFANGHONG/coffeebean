        ...
        {list.map((user,i)=><View 
            ...
            borderBottomColor:"#ccc",borderBottomWidth:pxToDp(1)
              ...
              <TouchableOpacity 
                ...
                <IconFont style={{color:"black",paddingRight:pxToDp(10),paddingLeft:pxToDp(25)}} name="iconaixin6"/>
                <Text style={{color:"#666",paddingLeft:pxToDp(10)}}>Cancel Followed</Text>
              </TouchableOpacity>
        </View>)}
      </View>
    )
